...
def test_als_n_epochs_field():
    ...
    algo = BaselineOnly(bsl_options=bsl_options)
    rmse_als_n_epochs_1 = cross_validate(algo, data, [['neg_rmse', neg_rmse]],
                                         pkf)['test_neg_rmse']
    ...
    algo = BaselineOnly(bsl_options=bsl_options)
    rmse_als_n_epochs_5 = cross_validate(algo, data, [['neg_rmse', neg_rmse]],
                                         pkf)['test_neg_rmse']
...
def test_als_reg_u_field():
    ...
    algo = BaselineOnly(bsl_options=bsl_options)
    rmse_als_regu_0 = cross_validate(algo, data, [['neg_rmse', neg_rmse]], pkf)[
        'test_neg_rmse']
...
def test_sgd_learning_rate_field():
    ...
    algo = BaselineOnly(bsl_options=bsl_options)
    rmse_sgd_lr_005 = cross_validate(algo, data, [['neg_rmse', neg_rmse]], pkf)[
        'test_neg_rmse']
...
def test_sgd_reg_field():
    ...
    algo = BaselineOnly(bsl_options=bsl_options)
    rmse_sgd_reg_1 = cross_validate(algo, data, [['neg_rmse', neg_rmse]], pkf)[
        'test_neg_rmse']
